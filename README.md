...
| `--columns-step INT` | `-s INT` | Шаг колонок анимации, по умолчанию 3 |
...
- Большой языковой модели [DeepSeek](https://chat.deepseek.com/) за помощь и консультации
- Сервису [www.freeconvert.com](https://www.freeconvert.com/convert/mp4-to-gif) за возможность удобной онлайн-конвертации видео в animated GIF
- Всем тестерам и контрибьюторам

## Список изменений

[CHANGELOG.md](CHANGELOG.md) - подробная информация об изменениях в каждой версии.
